...
insert into user values(1L, '11', sysdate(), '1', 1L);
insert into user values(2L, 'Alice@gmail.com', sysdate(), 'a', 2L);
insert into user values(3, 'Elena@gmail.com', sysdate(), 'a', null);
...
insert into post values(2L, '[에릭]', '병아리감별사', '2019-10-04', '@_golden_gate_', 1L);
insert into post values(3L, 'NCT 127 美 ''제임스 코든쇼'' 출연 화제! 신곡 ''Sticker'' 무대 최초 공개, 글로벌 팬열광!', '병아리감별사', '2020-02-01', '@_golden_gate_', 1L);
insert into post values(4L, '테스트 스트링입니다.', 'xaxxxx', '2020-01-01', '@Majj_manuel', 2L);
...
insert into post values(8L, 'Hello, there!? What is the anger means in your mind? I think it''s the thing that gives me power that makes me achieve what I want. Let''s show him I''m greater than they think I am.', 'Anitisitce', sysdate(), '@Anti', 4L);
